...
<?php
  // $id = 18;
	$rs	= $this->Object_model->getInfoContact($id);
?>
...
<div class="tp" style="width: 100%;">
	<div class="tp_width" style="margin: 0 auto;width: 700px;background-color: #FFF;padding: 40px;margin-top: 20px;margin-bottom: 40px;">
        ...
        <div class="request_box">
    		<h1  style="margin: 20px 0px 0px 0px;font-size: 18px;line-height: 28px;padding-bottom: 20px;">ติดต่อเรา</h1>

            <div class="title">
                <table width="100%" border="0" cellspacing="4" cellpadding="4"  style="margin-left: 20px;">
                    <tr>
                        <td width="30%" align="left" valign="top">ชื่อ - สกุล</td>
                        <td width="70%" align="left" valign="top" class="border_label" style="font-weight: 800;"><?=$rs["_contactus_FirstName"]." ".$rs["_contactus_LastName"]?></td>
                    </tr>
                    <tr>
                        <td width="30%" align="left" valign="top">อีเมล</td>
                        <td width="70%" align="left" valign="top" class="border_label" style="font-weight: 800;"><?=$rs["_contactus_Email"]?></td>
                    </tr>
                    <tr>
                        <td width="30%" align="left" valign="top">เบอร์โทร</td>
                        <td width="70%" align="left" valign="top" class="border_label" style="font-weight: 800;"><?=$rs["_contactus_Phone"]?></td>
                    </tr>
                    <tr>
                        <td align="left" valign="top">ข้อความ</td>
                        <td align="left" valign="top" class="border_label" style="font-weight: 800;"><?=$rs["_contactus_Subject"]?></td>
                    </tr>
                </table>
            </div>
