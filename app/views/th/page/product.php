      ...
      <div class="col-lg-9">
        <div class="product_box">
          <div class="product_box_flex">
            ...
            <div class="block_sortby order-1 order-md-2">
              <select class="select_box" name="txt_Order" id="txt_Order" onchange="js_product_order(this.value);">
                  ...
                  <option value="created_at_desc" <?=($txt_Order == 'created_at_desc')?'selected':''?>>ใหม่ไปเก่า</option>
                  <option value="created_at_asc" <?= ($txt_Order == 'created_at_asc') ? 'selected' : '' ?>>เก่าไปใหม่</option>
                  <option value="price_desc" <?= ($txt_Order == 'price_desc') ? 'selected' : '' ?>>ราคาสูงไปต่ำ</option>
                  <option value="price_asc" <?= ($txt_Order == 'price_asc') ? 'selected' : '' ?>>ราคาต่ำไปสูง</option>
              </select>
            </div>
          </div>
          ...
          <div class="product_home_flex">
            ...
            ?>
              <div class="product_not_found">ไม่พบสินค้า</div>
            <?php
            }
            ?>
