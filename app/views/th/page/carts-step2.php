        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="cart_box_send_product">
                    ...
                    <div class="cart_box_send_product_flex">
                        <div class="block">
                            <div class="title">แขวง/อำเภอ*</div>
                            <div id="area_ampure">
                                <select class="select_box" name="txt_Ampure" id="txt_Ampure">
                                    <option value="0">แขวง/อำเภอ</option>
                                    <?php
                                    if($ampure_row > 0){
                        ...
                        <div class="block">
                            <div class="title">เขต/ซอย*</div>
                            <div id="area_tumbon">
                                <select class="select_box" name="txt_Tumbon" id="txt_Tumbon">
                                    <option value="0">เขต/ซอย</option>
                                    <?php
                                    if($tumbon_row > 0){
                ...
                <div class="transport_way">    
                    ...
                    <div id="area_billing" style="display:<?=($txt_Billing == 1 || $txt_Billing == null || $txt_Billing == '0')?"none":""?>;">
                        <h1 class="header_billing">ที่อยู่สำหรับออกใบกำกับภาษี</h1>
                        <div class="cart_box_send_product">
                    ...
                    <!-- other billing -->
                    <div class="bnt_order bnt_top _web" name="order" onclick="js_carts_step2();">ดำเนินการต่อ</div>
            ...
            <div class="col">
                <div class="carts_line">
                    <a href="<?=site_url('carts')?>">
                        <input class="bnt_product_back" type="button" name="carts_product" value="< ตระกร้าสินค้า">
                    </a>
                </div>
            </div>
        </div>
