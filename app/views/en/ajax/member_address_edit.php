...
<div class="box_address_edit">
    ...
    <form name="myForm" id="myForm" method="POST">
        <div class="register_box_flex edit_profile_box">
            ...
            <div class="box_content2">
                ...
                <div class="txt_data box_registerTop">
                    <input type="radio" name="txt_Gender" id="txt_Gender1" value="male" <?=($txt_Gender === 'male')?'checked':''?> > 
                    <label for="txt_Gender1">Male</label>
                    &nbsp;&nbsp;&nbsp;
                    <input type="radio" name="txt_Gender" id="txt_Gender2" value="female" <?=($txt_Gender === 'female')?'checked':''?> > 
                    <label for="txt_Gender2">Female</label>
                </div>
            </div>
            ...
            <div class="box_content2">
                ...
                <div class="txt_data">
                    <input type="text" class="input_login" id="txt_Birthday" name="txt_Birthday"  value="<?=$txt_Birthday?>"  maxlength="100">
                </div>
            </div>
            ...
            <div class="box_content2">
                ...
                <div class="txt_data">
                    <input type="text" class="input_login" id="txt_Phone" name="txt_Phone" maxlength="10" value="<?=$txt_Phone?>" onKeyPress="return CheckNumericKeyInfo(event.keyCode, event.which);">
                </div>
            </div>
            ...
            <div class="box_content2">
                ...
                <div class="txt_data">
                    <input type="email" class="input_login" id="txt_Email" name="txt_Email" value="<?=$txt_Email?>" maxlength="100" onChange="emailCheck(this);" readonly>
                </div>
            </div>
            ...
            <div class="box_content2">
                ...
                <div class="txt_data">
                    <input type="text" class="input_login" id="txt_Moo" name="txt_Moo" value="<?=$txt_Moo?>" maxlength="100">
                </div>
            </div>
        ...
        <div class="txt-center">
            <a href="javascript:void(0);" onclick="js_memberUpdateInfo();">
