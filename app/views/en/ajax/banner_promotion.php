...
$_title = $bannerPromotion['_banner_promotion_Title'];
$_subject = $bannerPromotion['_banner_promotion_Subject'];
$_date = $this->Object_model->getEngThai ($bannerPromotion['_banner_promotion_DateB'])."-". $this->Object_model->getEngThai($bannerPromotion['_banner_promotion_DateE']);
...
<div id="box_share_promotion" class="box_share option_share_promotion">
    <div class="bnt_share_promotion"><img src="<?= base_url('img/banner-promotion/bnt-share-en.png') ?>"></div>
