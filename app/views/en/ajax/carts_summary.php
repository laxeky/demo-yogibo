...
<div class="carts_summary_block">
    ...
    <div class="product_carts">
        ...
        <h4>Product Lists</h4>
        <div class="product_items_list"><span id="carts_total_item"><?=$_item_sum?></span> lists</div>
        <div class="product_carts_flex">
            <div class="block_data">Subtotal</div>
    ...
    <a href="javascript:void(0);" onclick="js_carts_step1();">
        <div class="bnt_order bnt_product_carts">Continue</div>
    </a>
    <?php 
    }
    ?>
