        ...
        <div class="product_box">
          ...
          <div class="product_home_flex">
            ...
            foreach($arr_group as $group_id){
                ...
                $pd_name    = $pd_group[0]['_product_group_Title'];
            ...
            ?>
                    ...
                    <div class="product_border">
                        ...
                        ?>
                        <!-- <div class="list_box"><a href="javascript:void(0);" onclick="js_add_wishlist('<?=$id?>');"><img class="pos_wishlist" id="img_wishList_<?=$id?>" src="<?=base_url('img/products/icon-wishlist'.$_wishList_class.'.jpg')?>" alt="wishlist"></a></div> -->
                        <!-- bnt share -->
            ...
            ?>
                <a href="<?=site_url('products/'.$pd_name_url)?>">
                    <div class="bnt_viewall">view all</div>
                </a>
