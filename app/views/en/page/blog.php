           ...
           <div class="event_flex">
			...
			if($rs['_blog_DateB']){
				...
				echo "- ".changeformatDate($rs['_blog_DateE'],$language);
						...
						<div>
						 	<h2 class="style1"><?=$rs['_blog_TitleEn']?></h2>
						 </div>	
						 <div>
						 	<?=$rs['_blog_DescriptionEn']?>
						 </div>
						 
						<div class="shop_flex top20">
							
							<div class="list_box"><a href="<?=base_url().$language."/".$page."/view"."/".$key?>" ><div class="bnt_more2">Read More</div></a></div>
