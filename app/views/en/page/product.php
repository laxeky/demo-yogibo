      ...
      <div class="col-lg-3">
        ...
        if($product_groupRow > 0){
            foreach($product_group as $group){
                ...
                $_group_title   = $group['_product_group_Title'];
        ...
        <?php 
                if($product_group2Row > 0){
                    ...
                    foreach($product_group2 as $group2){
                        ...
                        $_group2_title   = $group2['_product_group_level2_Title'];
      ...
      <div class="col-lg-9">
        <div class="product_box">
          <div class="product_box_flex">
            ...
            <div class="block_sortby order-1 order-md-2">
              <select class="select_box" name="txt_Order" id="txt_Order" onchange="js_product_order(this.value);">
                  <option value="0">sort by</option>
                  <option value="created_at_desc" <?=($txt_Order == 'created_at_desc')?'selected':''?>>Newest to Oldest</option>
                  <option value="created_at_asc" <?= ($txt_Order == 'created_at_asc') ? 'selected' : '' ?>>Oldest to Newest</option>
                  <option value="price_desc" <?= ($txt_Order == 'price_desc') ? 'selected' : '' ?>>Price: High to Low</option>
                  <option value="price_asc" <?= ($txt_Order == 'price_asc') ? 'selected' : '' ?>>Price: Low to High</option>
              </select>
            </div>
          </div>
