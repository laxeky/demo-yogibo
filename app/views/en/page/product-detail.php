            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="product_nav_flex">
                        ...
                        ?>
                        <div class="block_data">/</div>
                        <div class="block_data"><a href="<?=site_url('products/'.$_product_url)?>"><?=$product['_product_Title']?></a></div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="product_detail_flex">
                        ...
                        <div class="product_information">
                            <h1><?=$product['_product_Title']?></h1>
                            <div class="line"></div>
                            <div class="title"><?=$product['_product_Subject']?></div>
                            <div class="product_price_flex">
                                ...
                                <div class="wishlist">
                                    <a href="javascript:void(0);" onclick="js_add_wishlist('<?=$product_id?>');">
                                        <img src="<?=base_url('img/products/icon-wishlist-inner.jpg')?>"> Add to Wishlist
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="product_qty_flex">
                                <div class="block">
                                    <span>QTY:</span> <input type="number" class="input_qty" name="txt_Number" id="txt_Number" maxlength="2" value="1" onkeydown="js_press_number(event);">
                                </div> 
                                <div class="block">
                                    <?php 
                                    ...
                                    if($_stock == 1){
                                    ?>
                                        <div class="bnt_carts" name="txt_addcarts" id="txt_addcarts" onclick="js_addProducts('<?=$product_id?>')">Add To Cart</div>
                                    <?php
                                    }else{
                                    ?>
                            ...
                            <div class="product_share_flex">
                                <div class="block">
                                    ...
                                    <div class="product_social_share_flex">
                                        ...
                                        <a href="javascript:void(0);" onclick="twitter_share('<?=$product['_product_Title'].' link:'.site_url('products/'.$_product_url)?>');"><div class="product_share share_twitter">twitter</div></a>
                                    </div> 
                                </div>
                                <div class="block">
                ...
                <div class="col-lg-12">
                    <div class="product_detail_box">
                        <ul class="product_detail_nav_flex">
                            <a href="javascript:void(0);" onclick="js_product_detail_tab(1);"><li id="product_detail1" class="active">Description</li></a>
                            <a href="javascript:void(0);" onclick="js_product_detail_tab(2);"><li id="product_detail2">Details</li></a>
                            <!-- <a href="javascript:void(0);" onclick="js_product_detail_tab(3);"><li id="product_detail3">Reviews</li></a> -->
                            <a href="javascript:void(0);" onclick="js_product_detail_tab(4);"><li id="product_detail4">Shipping</li></a>
                        </ul>
                        <div class="product_description">
                            <div id="list_data1"><?=$product['_product_Benefit']?></div>
                            <div id="list_data2" class="hide_content"><?=$product['_product_Eat']?></div>
                            ...
                            <div id="list_data4"  class="hide_content">
                                ...
                                <div class="product_shipping_flex">
                                    ...
                                    <div class="block1">Shipping To:</div>
                                    <div class="block2">All Provinces in Thailand.</div>

                                    <div class="block1">Delivery Time:</div>
                                    <div class="block2">7 - 10 Business Days</div>
