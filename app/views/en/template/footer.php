...
<div id="box_contact_icon" class="box_contactus">
  <div class="bnt_contactus" onclick="js_boxContact('show');">
    <img src="<?=base_url('img/template/icon-message.png')?>"> <span class="text_contact">Contact US</span>
  </div>
</div>

<div id="box_contact_box" class="box_contactus_input text-center">
  <div class="cHeader" onclick="js_boxContact('hide');">
    <img src="<?=base_url('img/template/icon-message.png')?>"> <span>Contact US</span> <img src="<?=base_url('img/contact/icon-down.png')?>">
  </div>
  <div class="cBody">
    <form name="cForm" id="cForm" method="POST">
      <div class="contact_form">
        <!-- block -->
        <div class="c_block">
          <input type="text" class="input_contactUs" id="contact_FirstName" name="contact_FirstName" maxlength="100" placeholder="Name">
        </div>
        <!-- block -->
        <!-- block -->
        <div class="c_block">
          <input type="text" class="input_contactUs" id="contact_LastName" name="contact_LastName" maxlength="100" placeholder="Surname">
        </div>
        <!-- block -->
        <!-- block -->
        <div class="c_block">
          <input type="text" class="input_contactUs" id="contact_Number" name="contact_Number" maxlength="10" placeholder="Phone Number" onKeyPress="return CheckNumericKeyInfo(event.keyCode, event.which);">
        </div>
        <!-- block -->
        <!-- block -->
        <div class="c_block">
          <input type="text" class="input_contactUs" id="contact_Email" name="contact_Email" maxlength="100" placeholder="E-mail" onChange="emailCheck(this);">
        </div>
        <!-- block -->
        <!-- block -->
        <div class="c_block">
          <textarea class="area_contactUs" id="contact_Message" name="contact_Message" placeholder="Message"></textarea>
        </div>
        <div class="b_block text-center">
          <a href="javascript:void(0);" onclick="js_contactBox();">
            <div class="bnt_send">Send</div>
          </a>
...
<div class="popup" id="carts_box">
  <div class="bnt_close"><a href='javascript:void(0);' onclick="$('#carts_box').fadeOut(300);"><img src="<?=base_url('img/popup/bnt-close.png')?>" /></a></div>
    ...
    <div class="carts_content_box">
      ...
      <div class="bnt_confirm" onclick="$('#carts_box').fadeOut(300);" >Continue shopping</div>
      <a href="<?=site_url('carts')?>"><div class="bnt_confirm">Checkout</div></a>
    </div>
	</div>
</div>
<!-- carts_box -->
...
<div class="bnt_close"><a href='javascript:void(0)' onclick="$('#contact_box').fadeOut(300);"><img src="<?=base_url('img/popup/bnt-close.png')?>" /></a></div>
    ...
    <div class="carts_content_box">
      ...
      <input class="bnt_confirm" type="button" value="OK" onclick="$('#contact_box').fadeOut(300);" />
    </div>
	</div>
</div>
<!-- popup -->
...
<div class="bnt_close"><a href='javascript:void(0)' onclick="$('#contact_box2').fadeOut(300);"><img src="<?=base_url('img/popup/bnt-close.png')?>" /></a></div>
    ...
    <div class="carts_content_box">
      <h2>Save completed</h2>
      <input class="bnt_send" type="button" value="OK" onclick="$('#contact_box2').fadeOut(300);" />
    </div>
	</div>
</div>
<!-- popup -->
...
<div class="bnt_close"><a href='javascript:void(0);' onclick="$('#confirm_box').fadeOut(300);"><img src="<?=base_url('img/popup/bnt-close.png')?>" /></a></div>
    ...
    <div class="carts_content_box">
      <h2>Save completed</h2>
      <input class="bnt_confirm" type="button" value="OK" onclick="$('#confirm_box').fadeOut(300);" />
    </div>
	</div>
</div>
<!-- carts_box -->
...
<div class="popup" id="id_subscribe">
    ...
    <h1>Subscribe to<br>Yogibo Thailand</h1>
    <div class="box_subscribe">
      <div id="area_subscribe">
        <form id="subscribeForm" name="subscribeForm" method="post">
          <!-- block -->
          <div class="subscribe_block">
            <input type="text" class="input_subscribe" id="subscribe_FirstName" name="subscribe_FirstName" maxlength="100" placeholder="Name">
          </div>
          <!-- block -->
          <!-- block -->
          <div class="subscribe_block">
            <input type="text" class="input_subscribe" id="subscribe_LastName" name="subscribe_LastName" maxlength="100" placeholder="Surname">
          </div>
          <!-- block -->
          <!-- block -->
          <div class="subscribe_block">
            <input type="text" class="input_subscribe" id="subscribe_Phone" name="subscribe_Phone" maxlength="10" placeholder="Phone Number" onKeyPress="return CheckNumericKeyInfo(event.keyCode, event.which);">
          </div>
          <!-- block -->
          <!-- block -->
          <div class="subscribe_block">
            <input type="text" class="input_subscribe" id="subscribe_Email" name="subscribe_Email" maxlength="100" placeholder="E-mail" onChange="emailCheck(this);">
          </div>
          <!-- block -->
          <!-- block -->
          <div class="subscribe_block">
            <a href="javascript:void(0);" onclick="js_subscribeBox();">
              <div class="bnt_subscribe">Send</div>
            </a>
...
<div class="popup" id="id_banner_promotion">
    ...
    <div id="area_banner_promotion" class="content">
...
<script>
  ...
  // $('#id_banner_promotion').fadeIn(300);
