...
<div class="template_nav_header">
  <div class="template_top_nav_flex">
    ...
    ?>
      <div class="block txt_login br0">
        <a href="javascript:void(0);" onclick="js_open_login();">LOG IN</a>
      </div>
      <div class="block txt_login br0">
        <a href="javascript:void(0);" onclick="js_open_register();">REGISTER</a>
      </div>
    <?php
    }
    ?>
    ...
    <div class="row">
      ...
      <div class="col-lg-10">
        ...
        <ul class="template_nav">
          ...
          <li><a href="<?=site_url()?>" class="<?=($menu == 'home')?'active':''?>">Main</a></li>
          <li><a href="<?=site_url('whyyogibo')?>" class="<?=($menu == 'whyyogibo')?'active':''?>">Why Yogibo</a></li>
          <li><a href="<?=site_url('howtoyogibo')?>" class="<?=($menu == 'howtoyogibo')?'active':''?>">How to Yogibo</a></li>
          <li><a href="<?=site_url('products')?>" class="<?=($menu == 'products')?'active':''?>">Products</a></li>
          <li><a href="<?=site_url('vdo')?>" class="<?=($menu == 'vdo')?'active':''?>">VDO</a></li>
          <li><a href="<?=site_url('Store')?>" class="<?=($menu == 'store')?'active':''?>">Stores</a></li>
          <li><a href="<?= site_url('blog') ?>" class="<?= ($menu == 'blog') ? 'active' : '' ?>">Blog</a></li>
          <li><a href="<?= site_url('event') ?>" class="<?= ($menu == 'event') ? 'active' : '' ?>">Event</a></li>
        </ul>
        <!-- template top -->
      </div>
    </div>
